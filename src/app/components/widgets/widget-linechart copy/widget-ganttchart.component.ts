...
@Component({
  selector: 'app-widget-ganttchart',
  standalone: true,
  imports: [],
  templateUrl: './widget-ganttchart.component.html',
  styleUrl: './widget-ganttchart.component.scss'
})
...
//##################################################################
  ...
  getWidget(): IDashboardWidget {
    return this.dashboardService.widgetUtils.getById(this.widgetId);
  }
